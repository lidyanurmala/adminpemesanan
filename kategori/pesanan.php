...
<div class="row no-gutters mt-5">
  ...
  <li class="nav-item">
    ...
    <div class="row">
    <h5 class="mt-4"><i class="fa-solid fa-cart-shopping mr-2"></i>Pesanan</h5>
      <div class="table-responsive mt-4 mb-4 ml-2">
      <a href="tambahkategori.php" class="btn btn-primary btn-sm mb-2"><i class="fa fa-plus me-2"></i>Tambah</a>
