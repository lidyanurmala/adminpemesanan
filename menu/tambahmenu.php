    ...
    <form action="" method="post" enctype="multipart/form-data">
          <div class="card mt-1 mb-2 mt-4" id="card">
            <div class="text-center">
                <h2 class="mt-2 mb-2 display-6" style="font-size:190%; line-height: 2rem;">Tambah Menu </h2>
            </div>
            ...
            <div class="mb-3">
              <label for="id_menu">ID Menu</label>
                <input type="text" class="form-control mt-2" name="id_menu" id="id_menu" required placeholder="ID Menu">
            </div>
            <div class="mb-3">
              <label for="nama_menu">Nama Menu</label>
                <input type="text" class="form-control mt-2" name="nama_menu" id="nama_menu" required placeholder="Nama Menu">
            </div>
            <div class="mb-3">
              <label for="harga">Harga</label>
                <input type="text" class="form-control mt-2" name="harga" id="harga" required placeholder="Harga">
            </div>
            <div class="mb-3">
              <label for="harga">Deskripsi</label>
                <input type="text" class="form-control mt-2" name="deskripsi" id="deskripsi" required placeholder="Deskripsi Menu">
            </div>
            <div class="mb-3">
              <label for="gambar">Gambar Menu</label>
                <input type="file" class="form-control mt-2" name="gambar" id="gambar" required placeholder="Gambar Menu">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="col-4 mb-2">
                    <button type="submit" name="tambahmenu" class="btn btn-primary" id="menu">Simpan</button>  
                </div>                            
                </div>
        </form>
    </div>
